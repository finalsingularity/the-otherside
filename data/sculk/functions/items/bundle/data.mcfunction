execute as @s[predicate=sculk:bundle/mainhand] run scoreboard players set $bundle_in sculk.items.bundle 0
execute as @s[predicate=sculk:bundle/offhand] run scoreboard players set $bundle_in sculk.items.bundle 1
